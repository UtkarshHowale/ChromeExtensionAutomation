...
public class BasePage {
	...
	protected BasePage() {
		...
		try {
			...
			file = new FileInputStream(
					System.getProperty("user.dir") + "\\src\\main\\java\\ConfigurationFiles\\config.properties");
	...
	protected static void intilizeConfiguration() {
		...
		options.addExtensions(new File(
				System.getProperty("user.dir") + "\\src\\main\\java\\ConfigurationFiles\\Google-Dictionary.crx"));
